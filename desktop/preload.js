...
contextBridge.exposeInMainWorld('api', {
  ...
  sheet: {
    ...
    getBrand: (dir) => ipcRenderer.invoke('sheet:getBrand', dir),
    saveBrand: (dir, data) => ipcRenderer.invoke('sheet:saveBrand', dir, data),
    genBrandRef: (dir) => ipcRenderer.invoke('sheet:genBrandRef', dir),
  ...
  pub2: {
    ...
    testImageHost: () => ipcRenderer.invoke('pub2:testImageHost'),
    ...
    getPubConfig: (dir) => ipcRenderer.invoke('pub2:getPubConfig', dir),
    setPubConfig: (dir, values) => ipcRenderer.invoke('pub2:setPubConfig', dir, values),
