...
- **스킬 22종** → `~/.claude/skills/` (기존 10 + content-director, reels-script, ad-storyboard, kr-guardrail-check, kr-voice-localizer, naver-blog-writer, naver-clip-writer, kakao-channel-writer, ima2)
